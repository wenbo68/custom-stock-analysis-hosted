...
const zh = {
  ...
  'tiered.note.reportTooFar': '下一次季度财报在 {days} 天以后。那么远的期权价格主要反映日常波动而非财报本身，因此不显示财报日涨跌幅。',
  ...
  'tiered.signalsExplainer': '「AI 建议」页是全产品的建议台账：每日分析、告警和本页的每次运行都会往里记一条，产品之后会用真实价格给这些建议打分。本页的完整四维报告只保存在这里的运行历史中；AI 建议里那条只是摘要。每次运行在 AI 建议里会出现两条：产品自带流程记的一条（来源 analysis）和分层分析记的一条（来源 tiered_analysis）。',
  ...
  'tiered.user.intro': '登录后用你自己的 AI 密钥发起分析。你的运行记录和密钥仅自己可见。',
  ...
  'tiered.user.model': 'AI 模型',
  'tiered.user.modelPh': '选择模型',
  'tiered.user.llmKey': '{provider} API 密钥',
  'tiered.user.keyPh': '粘贴密钥',
  'tiered.user.keySaved': '已保存 {hint}',
  'tiered.user.getKey': '获取密钥',
  'tiered.user.dataKeys': '数据源密钥（可选）',
  'tiered.user.dataKeysHelp': '留空则使用服务器的默认密钥。',
  'tiered.user.key.finnhub': 'Finnhub',
  'tiered.user.key.alphavantage': 'AlphaVantage',
  'tiered.user.key.fred': 'FRED',
  'tiered.user.usingDefault': '使用服务器默认',
  'tiered.user.remove': '移除',
  'tiered.user.willRemove': '保存后移除',
  'tiered.user.save': '保存',
  'tiered.user.saved': '已保存。',
  'tiered.user.saveError': '保存失败：{error}',
  'tiered.user.ready': '可以开始：{model}，密钥 {hint}',
  'tiered.user.notReady': '先选择模型并添加它的密钥，才能发起分析。',
...
const en: Record<UiTextKey, string> = {
  ...
  'tiered.dimensions': 'Data reports',
  ...
  'tiered.dimension.opinion': 'Opinion',
  ...
  'tiered.note.reportTooFar':
    'The next quarterly report is more than {days} days away. Option prices that far out mostly price ordinary day-to-day movement rather than the report, so no report-day move is shown.',
  ...
  'tiered.user.intro': 'Sign in to run analyses with your own AI key. Your runs and keys are private to you.',
  ...
  'tiered.user.model': 'AI model',
  'tiered.user.modelPh': 'Pick a model',
  'tiered.user.llmKey': '{provider} API key',
  'tiered.user.keyPh': 'Paste your key',
  'tiered.user.keySaved': 'Saved {hint}',
  'tiered.user.getKey': 'Get a key',
  'tiered.user.dataKeys': 'Data-source keys (optional)',
  'tiered.user.dataKeysHelp': 'Leave blank to use the server’s default keys.',
  'tiered.user.key.finnhub': 'Finnhub',
  'tiered.user.key.alphavantage': 'AlphaVantage',
  'tiered.user.key.fred': 'FRED',
  'tiered.user.usingDefault': 'Using the server default',
  'tiered.user.remove': 'Remove',
  'tiered.user.willRemove': 'Removed on save',
  'tiered.user.save': 'Save',
  'tiered.user.saved': 'Saved.',
  'tiered.user.saveError': 'Could not save: {error}',
  'tiered.user.ready': 'Ready: {model}, key {hint}',
  'tiered.user.notReady': 'Pick a model and add its key before starting a run.',
