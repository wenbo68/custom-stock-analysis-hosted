...
const zh = {
  ...
  'tiered.dimension.company_events': '公司新闻',
  'tiered.dimension.world_events': '世界新闻',
  'tiered.warnings': '警告',
  ...
  'tiered.altFilter.holdPh': '筛选最长持有…',
...
const en: Record<UiTextKey, string> = {
  ...
  'tiered.dimension.company_events': 'Company news',
  'tiered.dimension.world_events': 'World news',
  ...
  'tiered.altFilter.holdPh': 'Filter max hold...',
